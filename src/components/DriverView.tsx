      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-slate-200 px-4 py-3.5 shadow-sm flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <button
            onClick={onLogout}
            title="Đăng xuất"
            className="flex items-center gap-1.5 px-3 py-2 text-slate-500 hover:text-red-600 hover:bg-red-50 rounded-lg cursor-pointer transition-colors shrink-0"
          >
            <LogOut className="w-5 h-5" />
            <span className="hidden xs:inline text-xs font-bold">Đăng xuất</span>
          </button>
        </div>
      </header>
